...
with anki_vector.Robot(cache_animation_lists=False) as robot:
    # Vector rises fork
    robot.behavior.say_text("it's halloween dude")
    time.sleep(1)
    robot.motors.set_lift_motor(2)
    robot.audio.stream_wav_file("/home/pi/vector-python-sdk/wirepod/forcefield.wav", 100)
    robot.motors.set_lift_motor(-2)
    time.sleep(0.5)
    robot.motors.stop_all_motors()
    time.sleep(2)
    robot.motors.set_lift_motor(2)
    #robot.anim.play_animation('anim_eyepose_focused')
    robot.audio.stream_wav_file("/home/pi/vector-python-sdk/wirepod/spark.wav", 100)
    robot.motors.set_lift_motor(-2)
    time.sleep(0.5)
    robot.motors.stop_all_motors()
    robot.behavior.say_text("enjoy")
...
anim_qa_sync_head
23:50:56.518       events.EventHandler WARNING  Unknown Event type
